...
const renderArticle = (contentItem:{type:'paragraph' | 'image',content:'string', caption?:string}) => {
    switch (contentItem.type) {
        case 'paragraph':
            return <ArticleParagraph content={contentItem.content} />
        case 'image':
            return <ArticleImage imgSource={contentItem.content} caption={contentItem.caption}/>
    }
}
